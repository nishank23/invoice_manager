...
class CltBusinessInfoController extends GetxController {
  ...
  getData() {
    companyNameController.value.text =
        addNewClientController.clientById.value!.company!.name!;
    ownerNameController.value.text =
    ...
    alterMobileNumberController.value.text = addNewClientController
        .clientById.value!.company!.alternativeMobileNumber!;
    gstController.value.text =
        addNewClientController.clientById.value!.company!.gstNumber!;
    businessEmailController.value.text =
        addNewClientController.clientById.value!.company!.email!;
    businessWebsiteController.value.text =
        addNewClientController.clientById.value!.company!.website!;
    update();
    refresh();
  }

...
import '../../../global/widgets/MyPhotoView.dart';
import '../../../global/widgets/countryPicker.dart';
            ...
            Expanded(
              child: ListView(
                children: [
                  ...
                  GetBuilder<CreateProductsController>(
                    builder: (controller) {
                      return MyTextFiled(
                      ...
                      return MyTextFiled(
                        ...
                        suffixIcon: GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Obx(
                                  () => Text(
                                controller.selected_Currency.value,
                                style: text400_14,
                              ),
                            ),
                          ),
                          ...
                          onTap: () {
                            ImagePickerDialog.showMultiImagePickerDialog(
                              ...
                              onImagesSelected: (files) {
                                controller.imageFileList!.value.addAll(files);
                                controller.update();
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Text(
                                      "Browse",
                                      style: text400_14.copyWith(color: AppColor.white),
                                    ),
                                  )
                                ],
                              ),
                 ...
                 GetBuilder<CreateProductsController>(
                          ...
                          child: ListView.separated(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              return GestureDetector(
                                onTap: () {
                                  Get.to(() => MyPhotoView(
                                      imageUrl: controller.imageFileList![index]));
                                },
                                child: Stack(
                                  children: [
                                    ClipRRect(
                                    ...
                                    Positioned(
                                      ...
                                      child: GestureDetector(
                                        onTap: () {
                                          controller.imageFileList!.value.removeAt(index);
                                          controller.update();
                                        },
                                        child: Container(
                  ...
                  mybutton(
                    onTap: () {
                      ...
                      if(controller.selected_Currency.value == "Select"){
                        Fluttertoast.showToast(msg: "Please select Product Currency");
                        return;
                      }


                      if (formKey.currentState!.validate()) {
                        Map<String, Object> myformdata = Map();

                        myformdata["name"] =
                            controller.productTitleController.value.text;
                        myformdata["price"] =
                            int.parse(controller.productPriceController.value.text);

                        myformdata["currencySymbol"] =
                            controller.selected_Symbol.value.toString();
                        myformdata["productCurrency"] =
                            controller.selected_Currency.value.toString();
                        myformdata["description"] =
                            controller.productDescriptionController.value.text;

                        List<String> uploadFiles = [];
                        for (var file in controller.imageFileList!.value) {

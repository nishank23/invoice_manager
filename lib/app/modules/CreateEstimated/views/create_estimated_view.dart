...
class CreateEstimatedView extends GetView<CreateEstimatedController> {
  const CreateEstimatedView({Key? key}) : super(key: key);
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(flex: 5,
                    child: Center(
                      child: Text(
                        controller.id!=null?"Edit Estimate":"Create Estimate",
                        style: text700_18,
                      ),
                    ),
                  ),
                ...
                child: EasyStepper(
                    ...
                    steps: [
                      ...
                      EasyStep(
                        ...
                        customStep: controller.activeStep.value > 1
                            ? Icon(Icons.radio_button_checked,
                                color: controller.activeStep.value >= 1
                                    ? AppColor.primaryBlue
                                    : Colors.white,
                                size: 26.h)
                            : Container(

...
class InvoiceAddItemsView extends GetView<InvoiceAddItemsController> {
  ...
  Widget build(BuildContext context) {
    ...
    InvoiceAddItemsController controller =
    ...
    return Scaffold(
        ...
        body:  GetBuilder(
            builder: (InvoiceAddItemsController controller){
            ...
            child: Column(children: [
              ...
              mybutton(
                onTap: () async {
                  ...
                  controller.myaddedProductsList.clear();

                  for (var data in products!) {
                    if (data.isAdded != null && data.isAdded!) {
                      controller.myaddedProductsList.add(data);
                    }
                  }
              ...
              GetBuilder<InvoiceAddItemsController>(builder: (controller) {
                return ListView.separated(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  '${product.qty} QTY. X ${controller.formatPriceWithThousandSeparator(product.currencySymbol.toString(), product.price!)} RATE ',
                                ...
                                GestureDetector(
                                  onTap: () {
                                    controller.myaddedProductsList
                                        .remove(product);
                                    controller.getSubTotal();
                                    controller.update();
                                    controller.refresh();
                    ...
                    itemCount: controller.myaddedProductsList.length);
              }),
                    ...
                    child: Column(children: [
                      Row(
                        ...
                        children: [
                          ...
                          Text( controller.formatPriceWithThousandSeparator(
                              controller.selectedEstimateCurrency,
                              controller.subtotal), style: text400_16black)
                        ],
                      ),
                      SizedBox(
                        height: 24.h,
          ...
          */
                                    alignment: Alignment.center,
                                    padding:
                                    EdgeInsets.only(left: 5.w, bottom: 3.h),
                                    decoration: const ShapeDecoration(
                                      color: Colors.white,
                                      shape: RoundedRectangleBorder(
                                        borderRadius: BorderRadius.only(
                                    ...
                                    child: TextField(
                                        ...
                                        controller: controller.dscCntlr,
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text('After Discount', style: text400_16black),
                          Text(

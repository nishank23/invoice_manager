...
class CountryModelBottomSheetController extends GetxController {
  ...
  Future<CountryData?> getCountryModelSheet(
    ...
    await NetworkClient.getInstance.callApi(
      ...
      successCallback: (response, message) async {
        ...
        debugPrint("${allCountry.countryData}");
        update();
        refresh();

        final selectedCountry =
            await showCountryModelBottomSheet(context, countryData);
  ...
  void filterCountryList(String query) {
    ...
    if (query.isEmpty) {
      ...
      final List<CountryData> filteredList = countryData.where((country) {
        ...
        final String currencyName = country.currencyName!.toLowerCase();
  ...
  Future<CountryData?> showCountryModelBottomSheet(
      BuildContext context, List<CountryData> countryData) async {
